...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CART_PROPERTIES_7" => array("COLOR_R","SIZES_CLOTHES","SIZES_SHOES",""),
		"COMPARE_PATH" => SITE_DIR."catalog/compare/",
		"CONVERT_CURRENCY" => "N",
		"DEPTH" => "",
		"DETAIL_URL" => "",
		...
		"MOUSE_DRAG" => "Y",
		"OFFER_TREE_PROPS_7" => array("COLOR_R","SIZES_CLOTHES","SIZES_SHOES"),
		...
		"PROPERTY_CODE_7" => array("CML2_LINK","ARTNUMBER","COLOR_R","SIZES_CLOTHES","SIZES_SHOES",""),
		"RESPONSIVE_CAROUSEL_ITEMS_LG" => "4",
		"RESPONSIVE_CAROUSEL_ITEMS_MD" => "3",
		"RESPONSIVE_CAROUSEL_ITEMS_MOBILE" => "2",
		"RESPONSIVE_CAROUSEL_ITEMS_SM" => "3",
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PRODUCT_SUBSCRIPTION" => "Y",
		"PROPERTY_CODE_6" => array("",""),
		"PROPERTY_CODE_7" => array("CML2_LINK","COLOR_R","SIZES_CLOTHES","SIZES_SHOES",""),
		"RCM_TYPE" => "bestsell",
		"RESPONSIVE_CAROUSEL_ITEMS_LG" => "4",
		"RESPONSIVE_CAROUSEL_ITEMS_MD" => "3",
		"RESPONSIVE_CAROUSEL_ITEMS_MOBILE" => "2",
