...
data-elementid="<?php echo (!$OFFERS)? $arResult['ID'] : $arResult['OFFERS'][$arResult['OFFERS_SELECTED']]['ID'] ?>"
<?if ($OFFERS):?>
...
?>
						<?endforeach?>
      				<div class="detail-product-images-photorama-img<?if ($arResult['MORE_PHOTO_COUNT'] == 1):?> pl-0<?endif?>">
